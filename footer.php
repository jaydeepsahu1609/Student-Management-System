<footer>
                    ...
                    <div class="row">
                        <div class="col-lg-4 footer-link">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="register.php" target="_blank" rel="noopener noreferrer">Login/Register</a></li>
                                <li><a href="library.php" target="_blank" rel="noopener noreferrer">Library Managemnet Portal</a></li>
    ...
    <div class="container-fluid text-white-50 text-right">
        &copy;2020-21 jaydeepsahu
    </div>
</footer>