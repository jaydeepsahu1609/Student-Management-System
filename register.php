                    ...
                    <form action="request_action.php" method="post">
                        ...
                        <div class=" row form-group">
                            ...
                            <div class="col-lg-8 col-md-10 col-sm-10">
                                <input type="text" name="username" class="form-control text-dark text-left input-lg " maxlength="25" required>
                            </div>
                        </div>
                        ...
                        <div class=" row form-group">
                            ...
                            <div class="col-lg-8 col-md-10 col-sm-10">
                                <input type="text" name="fullname" class="form-control text-dark text-left input-lg" maxlength="45" required>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-lg-8 col-md-10 col-sm-10">
                                <input type="password" name="password" class="form-control text-dark text-left input-lg  " maxlength="25" required>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class=" col-lg-8 col-md-10 col-sm-10">
                                <input type="password" name="confirm_password" class="form-control text-dark text-left input-lg  " maxlength="25" required>
                            </div>
                        </div>
